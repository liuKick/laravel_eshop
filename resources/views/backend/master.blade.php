              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/list-attribute" class="menu-link">
                    <div data-i18n="Without menu">View Attribute</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/admin/add-attribute" class="menu-link">
                    <div data-i18n="Without menu">Add Attribute</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/admin/log-activity" class="menu-link">
                    <div data-i18n="Without menu">View Log</div>
                  </a>
                </li>
              </ul>
            </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="/uploads/{{ Auth::User()->profile }}" alt class="w-px-40 h-px-40 rounded-circle" style="object-fit: contain;"/>
                    </div>
                  </a>
